...
EXES=test_hh driver
OBJS=test_pams.o sketch.o test_hh.o exact_query.o pcm.o pla.o sampling.o heavyhitters.o test_pcm.o driver.o test_pla.o pams.o 
...
driver: driver.o pla.o pcm.o pams.o sampling.o heavyhitters.o sketch.o exact_query.o
...
exact_query.o: exact_query.cpp exact_query.cpp
