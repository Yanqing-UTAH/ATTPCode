...
EXES=test_hh driver
OBJS=pla.o sampling.o conf.o test_pla.o MurmurHash3.o heavyhitters.o test_pcm.o test_conf.o sketch.o test_hh.o pmmg.o misra_gries.o pcm.o exact_query.o test_pams.o driver.o pams.o 
