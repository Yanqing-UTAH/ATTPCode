...
EXES=test_hh driver
OBJS=test_pams.o sketch.o test_hh.o conf.o exact_query.o pcm.o pla.o sampling.o heavyhitters.o test_pcm.o driver.o test_pla.o test_conf.o pams.o 
...
exact_query.o: exact_query.cpp exact_query.h sketch.h
...
driver.o: driver.cpp sketch.h util.h conf.h hashtable.h
