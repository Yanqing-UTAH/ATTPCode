...
EXES=test_hh driver
OBJS=test_pams.o sketch.o test_hh.o conf.o exact_query.o misra_gries.o pcm.o pla.o sampling.o heavyhitters.o test_pcm.o driver.o pmmg.o test_pla.o test_conf.o MurmurHash3.o pams.o 
...
driver: driver.o pla.o pcm.o pams.o sampling.o heavyhitters.o sketch.o exact_query.o conf.o misra_gries.o pmmg.o MurmurHash3.o
